...
body {
  ...
  /* Fija la imagen de fondo en la ventana del navegador */
  overflow: hidden;
}
...
#textContainer {
  ...
  width: 100vw;
  height: 100vh;
  /* Asegura que ocupe toda la ventana del navegador */
  overflow: hidden;
...
#header {
  ...
  z-index: 100;
  /* Coloca el navbar encima del fondo */
...
#Fondo_Login {
  ...
  z-index: -1;
  /* Coloca el fondo detrás de todo */
  opacity: 0.5;
...
.TextSign {
  ...
  top: -200%;
  left: 25%;
  /* Ajusta la posición del texto desde el lado izquierdo */
...
.brandTextLeft5 {
  ...
  margin-left: -150px;
  margin-top: 10px;
  /* Ajusta la posición del texto hacia abajo */
  white-space: normal;
  position: absolute;
  /* Make the element positioned absolutely */
  color: #fff;
...
.button2-text {
  margin-left: -2%;
  /* Remove or adjust margin-left */
  margin-top: 2%;
  /* Remove or adjust margin-top */
  white-space: nowrap;
  text-align: center;
  font-family: 'Bebas Neue', sans-serif;
  font-size: 17px;
...
.button2-text a {
  color: #000000;
  /* Reemplaza esto con el color del enlace de router-link */
}
